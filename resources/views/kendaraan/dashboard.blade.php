...
<head>
    ...
    <title>{{ config('app.name') }} | Kendaraaan | Dashboard</title>
</head>
<body>
        ...
        <div class="sidebar pe-3">
            <nav class="navbar d-flex">
                ...
                <div class="navbar-nav w-100 gap-2 fw-medium mt-7 mt-lg-0">
                    <a href="{{ route('kendaraan.dashboard') }}" class="nav-item side-item nav-link ps-4 py-3 d-flex align-items-center active">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light text-center rounded p-4">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                ...
                                <form action="{{ route('kendaraan.dashboard') }}" method="GET ">
                                    @csrf
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light text-center rounded p-4">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                ...
                                <a href="{{ route('kendaraan.data.peminjaman') }}" class="text-decoration-none">Lihat Semua</a>
                            </div>
