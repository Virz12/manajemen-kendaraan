...
<head>
    ...
    <title>{{ config('app.name') }} | Kendaraan | Arsip Peminjaman</title>
</head>
<body>  
    <div class="container-fluid p-0">
        ...
        <div class="sidebar pe-3">
            <nav class="navbar d-flex">
                ...
                <div class="navbar-nav w-100 gap-2 fw-medium mt-7 mt-lg-0">
                    <form class="d-flex d-md-none ms-3 mb-3" action="{{ route('kendaraan.arsip') }}" method="GET"> {{-- Form Sidebar --}}
        ...
        <main class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-1">
                ...
                <form class="d-none d-md-flex ms-4" action="{{ route('kendaraan.arsip') }}" method="GET"> {{-- Form Navbar --}}
                    <input class="form-control border-0" type="search" name="keyword" value="{{ $keyword }}" placeholder="Cari..">
                </form>
