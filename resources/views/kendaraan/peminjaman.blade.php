...
<head>
    ...
    <title>{{ config('app.name') }} | Kendaraaan | Data | Peminjaman</title>
</head>
<body>  
    <div class="container-fluid p-0">
        ...
        <div class="sidebar pe-3">
            <nav class="navbar d-flex">
                ...
                <div class="navbar-nav w-100 gap-2 fw-medium mt-7 mt-lg-0">
                    <form class="d-flex d-md-none ms-3 mb-3" action="{{ route('kendaraan.data.peminjaman') }}" method="GET"> {{-- Form Sidebar --}}
        ...
        <main class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-1">
                ...
                <form class="d-none d-md-flex ms-4" action="{{ route('kendaraan.data.peminjaman') }}" method="GET"> {{-- Form Navbar --}}
                    <input class="form-control border-0" type="search" name="keyword" value="{{ $keyword }}" placeholder="Cari..">
                </form>
            ...
            <div class="container-fluid pt-4 px-4 pb-4">
                <div class="row g-2 pb-2">
                    <div class="col-md-3">
                        <a href="{{ route('kendaraan.arsip') }}" class="btn btn-primary rounded">Arsip <i class="fa-solid fa-box-archive"></i></a>
                    </div>
                </div>
