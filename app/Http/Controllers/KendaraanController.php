...
class KendaraanController extends Controller
{
    ...
    function storekendaraan(Request $request)
    {
        ...
        ->layout('bottomRight')
        ->timeout(3000)
        ->error('<b>Error!</b><br>Data kendaraan gagal ditambah.');
        ...
        ->layout('bottomRight')
        ->timeout(3000)
        ->success('<b>Berhasil!</b><br>Data kendaraan berhasil ditambah.');
    ...
    function updatekendaraan(Request $request, kendaraan $kendaraan)
    {
        ...
        ->layout('bottomRight')
        ->timeout(3000)
        ->error('<b>Error!</b><br>Data kendaraan gagal diperbarui.');
        ...
        ->layout('bottomRight')
        ->timeout(3000)
        ->success('<b>Berhasil!</b><br>Data kendaraan berhasil diperbarui.');
    ...
    function deletekendaraan(kendaraan $kendaraan)
    {
        ...
        ->layout('bottomRight')
        ->timeout(3000)
        ->success('<b>Berhasil!</b><br>Data kendaraan berhasil dihapus.');
